...
<!-- NAV -->
<nav>
  <div class="nav-logo"><?php echo e($config->nombre_negocio); ?></div>
  <div class="nav-links">
    <a href="#reservar">Reservar</a>
    <a href="#nosotros">Nosotros</a>
    <a href="#experiencia">Experiencia</a>
    <a href="tel:+50412345678"><?php echo e($config->telefono); ?></a>
  </div>
  <!-- Mobile menu button -->
...
<footer style="border-top:1px solid rgba(201,168,76,0.12);padding:80px 24px 40px;">
  <div style="max-width:1100px;margin:0 auto;">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:48px;margin-bottom:64px;">
      <div>
        <div style="font-family:'Playfair Display',serif;..."><?php echo e($config->nombre_negocio); ?></div>
      ...
      <div>
        ...
        <div style="font-size:0.85rem;color:rgba(245,240,232,0.5);line-height:2;">
          <p><?php echo e($config->telefono); ?></p>
...
</html><?php /**PATH C:\Users\Ryzen Gaming\Documents\SISTEMA DE RESTAURANTE\restaurante-laravel\resources\views/landing/reservaciones.blade.php ENDPATH**/ ?>