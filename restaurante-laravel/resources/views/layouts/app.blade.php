...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    @endif
                    @if(auth()->user()->esRecepcionista() || auth()->user()->esAdmin())
                        <li class="nav-item">
                    ...
                    @if(auth()->user()->esCocinero() || auth()->user()->esAdmin())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('cocina.index') }}">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-{{ auth()->check() ? '10' : '12' }} ms-sm-auto col-lg-{{ auth()->check() ? '10' : '12' }} px-md-4 py-4">
                @if(session('success'))
