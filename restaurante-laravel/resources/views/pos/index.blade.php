                ...
                <div class="mesa-grid">
                    ...
                    <div class="position-relative">
                        ...
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning text-dark"
                              ...
                              onclick="event.stopPropagation(); verReservaciones({{ $mesa->id }})">
                            <i class="bi bi-calendar-check"></i> {{ $reservasMesa->count() }}
                        </span>
                        @endif
                    </div>
                    @endforeach
            ...
            <div class="card-body p-2">
                <div class="categoria-tabs">
                    <ul class="nav nav-pills flex-nowrap" id="categoriasTab">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-categoria="{{ $cat->id }}"
            ...
            <div class="card-body">
                <div class="row g-3" id="productosGrid">
                    @foreach($categorias as $cat)
                        ...
                        <div class="col-6 col-md-4 col-lg-3 producto-wrapper" data-categoria="{{ $cat->id }}">
                            <div class="card producto-item h-100 {{ $prod->stock <= 0 ? 'producto-sin-stock' : '' }}"
                                ...
                                <div class="card-body p-2 text-center">
                                    ...
                                    @elseif($prod->stock < 10)
                                        <small class="text-warning">Stock: {{ $prod->stock }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary">{{ $pedidosActivos->count() }}</span>
            </div>
            <div class="card-body p-0">
                    ...
                    <a href="#" class="list-group-item list-group-item-action"
                       onclick="verDetallePedido({{ $pedido->id }})">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-1">
                                @if($pedido->mesa) Mesa {{ $pedido->mesa->numero }}
                                @else {{ $pedido->cliente_nombre ?: 'Sin nombre' }}
                                @endif
                            </h6>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- Código de transacción (obligatorio para transferencia) --}}
