...
<section class="hero" id="inicio">
  ...
  <div class="hero-content">
    ...
    <p class="hero-subtitle">
      Reserva tu mesa en {{ $config->nombre_negocio }} y disfruta de una experiencia gastronómica única. Confirmamos tu reservación en menos de 2 horas.
    </p>
...
<section class="section form-section" id="reservar">
  <div class="form-wrapper">
    ...
    @foreach($horas as $hora)
        ...
        @endphp
        <option value="{{ $hora }}">{{ $label }}</option>
    @endforeach
</select>
          </div>
        </div>
...
<footer>
  <div class="footer-inner">
    ...
    <div class="footer-bottom">
      <p>© 2026 {{ $config->nombre_negocio }}. Todos los derechos reservados.</p>
